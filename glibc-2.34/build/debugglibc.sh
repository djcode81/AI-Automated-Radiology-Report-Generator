...
SOURCE_DIR="/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34"
BUILD_DIR="/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/"
CMD_FILE="/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/debugglibc.gdb"
CONTAINER=false
DIRECT=true
STATIC=false
SYMBOLSFILE=true
...
run --library-path /teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build:/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/math:/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/elf:/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/dlfcn:/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/nss:/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/nis:/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/rt:/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/resolv:/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/mathvec:/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/support:/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/crypt:/teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/nptl:${BUILD_DIR}/nptl_db __COMMANDLINE__ __DIRECT__
__BREAKPOINTS__
EOF
}
...
WAIT_FOR_DEBUGGER=1 /teamspace/studios/this_studio/AI-Automated-Radiology-Report/glibc-2.34/build/testrun.sh --tool=container ${TESTCASE} &
gdb -x ${TESTCASE}.gdb
elif [ "$STATIC" == true ]
then
gdb ${TESTCASE}
